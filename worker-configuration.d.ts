/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b6bf30526085b9f9f63ad1abca7e162f)
// Runtime types generated with workerd@1.20260921.1 2026-09-22 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	APPLE_MAPKIT_TOKEN: string;
	SHUTTLE: DurableObjectNamespace<import("./src/worker").ShuttleState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ShuttleState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APPLE_MAPKIT_TOKEN">> {}
}
